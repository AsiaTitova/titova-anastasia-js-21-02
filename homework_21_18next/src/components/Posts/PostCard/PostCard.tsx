        ...
        {!loading && (
          <>
            <div className="post-card__head">
              ...
              <button className="post-card__close" type="button" onClick={onPostCardClose}></button>
            </div>
            <div className="post-card__content">
              ...
              <div className="post-card__comments comments">
                <h2 className="comments__title">{t('comment.title')}</h2>
                ...
                ) : (<p className="comments__empty">{t('comment.noComments')}</p>)}
              </div>
